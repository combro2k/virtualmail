...
urlpatterns = patterns('',
    url(r'^$', RedirectView.as_view(url=reverse_lazy('hyperkitty.views.index.index')), {"SSL": True}),
    url(r'^postorius/', include('postorius.urls'), {"SSL": True}),
    url(r'^archives/', include('hyperkitty.urls'), {"SSL": True}),
